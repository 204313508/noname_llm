...
3. Run the program using the following Python code. The model will be automatically downloaded.
The execution method for the v3.x model is as follows:
```python
...
The execution method for the v2.x 和 v1.x model is as follows:
```python
from transformers import AutoModelForCausalLM, AutoTokenizer
